...
double	64-bit double-precision floating 
		point type								(+/-)5.0 x 10-324 to (+/-)1.7 x 10308			0.0D
float	32-bit single-precision floating 
		point type								-3.4 x 1038 to + 3.4 x 1038						0.0F
...
boxing - converting a value to an object
unboxing - converting an object to a value
